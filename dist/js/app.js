(function (e) {
  function a(a) {
    for (
      var n, t, s = a[0], l = a[1], d = a[2], c = 0, p = [];
      c < s.length;
      c++
    )
      (t = s[c]),
  ...
  "93b7": function (e, a, o) {
    ...
    var n = o("2b0e"),
      i = function () {
        var e = this,
          a = e.$createElement,
          o = e._self._c || a;
        return e.$store.state.initialized
          ? o(
              "div",
              { attrs: { id: "wrapper" } },
              [
                ...
                e.can("read") ||
                e.can("upload")
                  ? o("div", { attrs: { id: "inner" } }, [o("router-view")], 1)
                  : o("Login"),
              ],
              1
            )
      ...
      t = function () {
        var e = this,
          a = e.$createElement,
          o = e._self._c || a;
        return e.$store.state.config.guest_redirection
          ? e._e()
          : o("div", [
              e.can("read")
                ? o(
                    ...
                    [o("b-icon", { attrs: { icon: "times" } })],
                    1
                  )
                : e._e(),
              o(
                "div",
                { staticClass: "columns is-centered", attrs: { id: "login" } },
                [
                  o("div", { staticClass: "column is-narrow" }, [
                    o(
                      "form",
                      {
                        on: {
                      ...
                      [
                        o(
                          ...
                          { staticClass: "box" },
                          [
                            o("div", { staticClass: "has-text-centered" }, [
                              o("img", {
                                staticClass: "logo",
                                attrs: { src: e.$store.state.config.logo },
                              }),
                            ]),
                            o("br"),
                            o(
                              "b-field",
                              { attrs: { label: e.lang("Username") } },
                              [
                                o("b-input", {
                                  ref: "username",
                            ...
                            o(
                              ...
                              [
                                o(
                                  ...
                                  [e._v(" " + e._s(e.lang("Login")) + " ")]
                                ),
                              ]
                            ),
                            e.error
                              ? o("div", [o("code", [e._v(e._s(e.error))])])
                              : e._e(),
                          ],
                          1
                        ),
      ...
      c = {
        ...
        getUser: function () {
          return new Promise(function (e, a) {
            d.a
              .get("getuser")
              .then(function (a) {
                (d.a.defaults.headers.common["x-csrf-token"] =
                  a.headers["x-csrf-token"]),
                  e(a.data.data);
              })
              ["catch"](function (e) {
                return a(e);
        ...
        login: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("login", { username: e.username, password: e.password })
              .then(
                function (e) {
                  a(e.data.data);
                },
        ...
        copyItems: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("copyitems", { destination: e.destination, items: e.items })
              .then(function (e) {
                return a(e.data.data);
              })
              ["catch"](function (e) {
        ...
        moveItems: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("moveitems", { destination: e.destination, items: e.items })
              .then(function (e) {
                return a(e.data.data);
              })
              ["catch"](function (e) {
        ...
        batchDownload: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("batchdownload", { items: e.items })
              .then(function (e) {
                return a(e.data.data);
              })
              ["catch"](function (e) {
        ...
        unzipItem: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("unzipitem", { item: e.item, destination: e.destination })
              .then(function (e) {
                return a(e.data.data);
              })
              ["catch"](function (e) {
        ...
        removeItems: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("deleteitems", { items: e.items })
              .then(function (e) {
                return a(e.data.data);
              })
              ["catch"](function (e) {
        ...
        downloadItem: function (e) {
          return new Promise(function (a, o) {
            d.a
              .get(
                "download&path=" +
                  encodeURIComponent(u["Base64"].encode(e.path)),
                {
                  transformResponse: [
                    function (e) {
                      return e;
        ...
        saveContent: function (e) {
          return new Promise(function (a, o) {
            d.a
              .post("savecontent", { name: e.name, content: e.content })
              .then(function (e) {
                return a(e.data);
              })
              ["catch"](function (e) {
      ...
      m = {
        ...
        mounted: function () {
          this.$store.state.config.guest_redirection
        ...
        methods: {
          login: function () {
            var e = this;
            p.login({ username: this.username, password: this.password })
              .then(function (a) {
                e.$store.commit("setUser", a),
                  p.changeDir({ to: "/" }).then(function () {
                    return e.$router.push("/")["catch"](function () {});
                  });
              })
              ["catch"](function (a) {
                a.response && a.response.data
                  ? (e.error = e.lang(a.response.data.data))
                  : e.handleError(a),
                  (e.password = "");
              });
          },
      ...
      U = function () {
        ...
        return o(
          ...
          [
            e.isLoading ? o("div", { attrs: { id: "loading" } }) : e._e(),
            e.can("upload")
              ? o("Upload", {
                  directives: [
                    {
                  ...
                  attrs: { files: e.files, "drop-zone": e.dropZone },
                })
              : e._e(),
            e.dropZone && !e.isLoading
              ? o("b-upload", { attrs: { multiple: "", "drag-drop": "" } }, [
                  o("b", { staticClass: "drop-info" }, [
                    e._v(e._s(e.lang("Drop files to upload"))),
                  ]),
                ])
              : e._e(),
            e.dropZone
                    ...
                    o(
                      ...
                      [
                              ...
                              [
                                o(
                                  ...
                                  [
                                    o(
                                      "ul",
                                      e._l(e.breadcrumbs, function (a, n) {
                                        return o("li", { key: n }, [
                                          o(
                                            "a",
                                            {
                        ...
                        o(
                          ...
                          {
                            staticClass: "is-flex is-justify-between",
                            attrs: { id: "multi-actions" },
                          },
                          [
                            o(
                              "div",
                              [
                                e.can("upload") && !e.checked.length
                                  ? o(
                                      "b-field",
                                  ...
                                  : e._e(),
                                e.can(["read", "write"]) && !e.checked.length
                                  ? o(
                                      "a",
                                      {
                                  ...
                                  : e._e(),
                                e.can("batchdownload") && e.checked.length
                                  ? o(
                                      "a",
                                      {
                                        staticClass: "is-inline-block",
                                        on: { click: e.batchDownload },
                                      },
                                      [
                                        o("b-icon", {
                                          attrs: {
                                        ...
                                        e._v(
                                          " " + e._s(e.lang("Download")) + " "
                                        ),
                                      ],
                                      1
                                    )
                                  : e._e(),
                                e.can("write") && e.checked.length
                                  ? o(
                                      "a",
                                      {
                                        staticClass: "is-inline-block",
                                ...
                                e.can("write") && e.checked.length
                                  ? o(
                                      ...
                                      [
                                        ...
                                        e._v(" " + e._s(e.lang("Move")) + " "),
                                      ],
                                      1
                                    )
                                  : e._e(),
                                e.can(["write", "zip"]) && e.checked.length
                                  ? o(
                                      "a",
                                      {
                                        staticClass: "is-inline-block",
                                                            ...
                                                            directives: [
                                                              {
                                                                ...
                                                                expression:
                                                                  "getDownloadLink(props.row.path)",
                                                                arg: "copy",
                                                              },
                                                            ],
                                                            attrs: {
                        ...
                        o(
                          ...
                          [
                            ...
                            e.showAllEntries || e.hasFilteredEntries
                              ? o("div", [
                                  o("input", {
                                    attrs: { type: "checkbox", id: "checkbox" },
                                    on: { click: e.toggleHidden },
                                  }),
                                  o("label", { attrs: { for: "checkbox" } }, [
                                    e._v(" " + e._s(e.lang("Show hidden"))),
                                  ]),
                                ])
                              : e._e(),
                          ]
      ...
      C =
        ...
        function () {
          ...
          return o(
            ...
            [
              o("div", { staticClass: "navbar-brand" }, [
                o(
                  "a",
                  {
                  ...
                  [o("img", { attrs: { src: this.$store.state.config.logo } })]
                ),
                o(
                  "a",
                  {
                    class: [
                      e.navbarActive ? "is-active" : "",
                  ...
                  o("div", { staticClass: "navbar-end" }, [
                    ...
                    e.is("guest")
                      ...
                      : o(
                          ...
                          [e._v(" " + e._s(this.$store.state.user.name) + " ")]
                        ),
                    e.is("guest")
                      ? e._e()
                      : o(
            ...
            o(
              ...
              [
                o(
                  ...
                  [
                    o("b-input", {
                      attrs: { "password-reveal": "", required: "" },
                      nativeOn: {
                        keydown: function (a) {
      ...
      _ = {
        name: "Profile",
        data: function () {
          return { oldpassword: "", newpassword: "", formErrors: {} };
        },
        methods: {
          save: function () {
            var e = this;
            p.changePassword({
              ...
              ["catch"](function (a) {
                "object" != Object(A["a"])(a.response.data.data) &&
                  e.handleError(a),
                  F.a.forEach(a.response.data, function (a) {
      ...
      E = {
        ...
        methods: {
          ...
          profile: function () {
            this.$modal.open({ parent: this, hasModalCard: !0, component: T });
          },
        },
      },
      $ = E,
      ...
      B = function () {
        ...
        return o("div", { staticClass: "modal-card" }, [
          o("header", { staticClass: "modal-card-head" }, [
            o("p", { staticClass: "modal-card-title" }, [
              e._v(" " + e._s(e.lang("Select Folder")) + " "),
            ]),
          ]),
          o("section", { staticClass: "modal-card-body" }, [
            o("div", { staticClass: "tree" }, [
              o(
                "ul",
                { staticClass: "tree-list" },
                [
                  o("TreeNode", {
                    attrs: { node: e.$store.state.tree },
                    on: {
                      selected: function (a) {
        ...
        return o(
          ...
          [
            o(
              "b-button",
              {
                attrs: { type: e.button_type, size: "is-small" },
                on: {
                  click: function (a) {
              ...
              [o("span", { staticClass: "icon" }, [o("i", { class: e.icon })])]
            ),
            e._v(" "),
            o(
              "a",
            ...
            e.node.children && e.node.children.length
              ? o(
                  "ul",
                  e._l(e.node.children, function (a, n) {
                    return o("TreeNode", {
                      key: n,
                      attrs: { node: a },
                      on: {
      ...
      M = {
        ...
        data: function () {
          return { active: !1, button_type: "is-primary" };
        },
        computed: {
          icon: function () {
            return {
        ...
        mounted: function () {
          "/" == this.node.path &&
            (this.$store.commit("resetTree"), this.toggleButton(this.node));
        },
        methods: {
      ...
      Z = M,
      I = (o("4aca"), Object(g["a"])(Z, V, H, !1, null, "45d0a157", null)),
      W = I.exports,
      K = { name: "Tree", components: { TreeNode: W } },
      G = K,
      Y = (o("b069"), Object(g["a"])(G, B, O, !1, null, null, null)),
      J = Y.exports,
      Q = function () {
        var e = this,
          a = e.$createElement,
      ...
      oe = {
        name: "Editor",
        components: { PrismEditor: ae.a },
        props: ["item"],
        data: function () {
          return { content: "", currentItem: "", lineNumbers: !0 };
        },
        mounted: function () {
          var e = this;
          (this.currentItem = this.item),
            p
              .downloadItem({ path: this.item.path })
              .then(function (a) {
                e.content = a;
              })
              ["catch"](function (a) {
        ...
        methods: {
          saveFile: function () {
            var e = this;
            p.saveContent({ name: this.item.name, content: this.content })
              .then(function () {
                e.$toast.open({
                  message: e.lang("Updated"),
                  type: "is-success",
      ...
      te = function () {
        ...
        return o("div", [
          o("div", { staticClass: "modal-card" }, [
            o("div", { staticClass: "modal-card-body preview" }, [
              o("strong", [e._v(e._s(e.currentItem.name))]),
              o("div", { staticClass: "columns is-mobile" }, [
                o("div", { staticClass: "column mainbox" }, [
                  o("img", {
                    staticClass: "mainimg",
                    attrs: { src: e.imageSrc(e.currentItem.path) },
                  }),
                ]),
                e.images.length > 1
                  ? o("div", { staticClass: "column is-one-fifth sidebox" }, [
                      o(
                        "ul",
                        e._l(e.images, function (a, n) {
                          return o("li", { key: n }, [
                            o("img", {
                              directives: [
                                {
      ...
      de = le,
      ue = (o("ffc1"), Object(g["a"])(de, te, se, !1, null, "a2048f66", null)),
      ce = ue.exports,
      pe = function () {
        var e = this,
          a = e.$createElement,
        ...
        return o("div", { staticClass: "modal-card" }, [
          o(
            ...
            [
              o("p", { staticClass: "modal-card-title" }, [
                e._v(" " + e._s(e.lang("Search")) + " "),
              ]),
              o("b-loading", {
                attrs: { "is-full-page": !1, active: e.searching },
                on: {
          ...
          o(
            ...
            [
              o("b-input", {
                ref: "input",
                attrs: { placeholder: e.lang("Name") },
                on: { input: e.searchFiles },
                model: {
                  value: e.term,
                  callback: function (a) {
                    e.term = a;
        ...
        o("4795"),
        {
          ...
          mounted: function () {
            (this.active = !0),
              ...
              this.$store.state.config.search_simultaneous ||
          ...
          methods: {
            ...
            searchFiles: F.a.debounce(function (e) {
              (this.results = []),
                e.length > 0 &&
                  ((this.searching = !0), this.getDirLimited("/"));
            }, 1e3),
            getDirLimited: function (e) {
              var a = this,
                o = setInterval(function () {
                  a.active &&
                    a.pending_getdirs <
                      a.$store.state.config.search_simultaneous &&
                    (a.pending_getdirs++, clearInterval(o), a.getDir(e));
                }, 200);
            },
            getDir: function (e) {
              var a = this;
              (this.searching = !0),
                p
                  ...
                  .then(function (o) {
                    (a.searching = !1),
                      a.pending_getdirs--,
                      F.a.forEach(o.files, function (o) {
                        o.name.toLowerCase().indexOf(a.term.toLowerCase()) >
                          -1 && a.results.push({ file: o, dir: e });
                      }),
                      F.a.forEach(
                        F.a.filter(o.files, ["type", "dir"]),
                        function (e) {
        ...
        return o(
          ...
          [
            o(
              "b-select",
              {
                attrs: { value: e.perpage, size: "is-small" },
                on: {
                  input: function (a) {
                    return e.$emit("selected", a);
                  },
              ...
              [
                o("option", { attrs: { value: "" } }, [
                  e._v(" " + e._s(e.lang("No pagination")) + " "),
                ]),
                o("option", { attrs: { value: "5" } }, [
                  e._v(" " + e._s(e.lang("Per page", 5)) + " "),
                ]),
                o("option", { attrs: { value: "10" } }, [
                  e._v(" " + e._s(e.lang("Per page", 10)) + " "),
                ]),
                o("option", { attrs: { value: "15" } }, [
                  e._v(" " + e._s(e.lang("Per page", 15)) + " "),
                ]),
              ]
            ),
          ],
      ...
      ye = [],
      be = { name: "Pagination", props: ["perpage"] },
      ke = be,
      ...
      ze = function () {
        var e = this,
          ...
          o = e._self._c || a;
        return o("div", [
          e.visible && 0 == e.dropZone
            ? o("div", { staticClass: "progress-box" }, [
                o("div", { staticClass: "box" }, [
                  o("div", [
                    o("div", { staticClass: "is-flex is-justify-between" }, [
                      o("div", { staticClass: "is-flex" }, [
                        o(
                          "a",
                          { on: { click: e.toggleWindow } },
                          [
                            o("b-icon", {
                              attrs: {
                                icon: e.progressVisible
                                  ? "angle-down"
                                  : "angle-up",
                              },
                            }),
                        ...
                        e.activeUploads
                              ...
                              e._v(
                                " " +
                                  e._s(
                                    e.lang(
                                      "Uploading files",
                                      e.resumable.getSize() > 0
                                        ? Math.round(
                                            100 * e.resumable.progress()
                                          )
                                        : 100,
                                      e.formatBytes(e.resumable.getSize())
                                    )
                                  ) +
                                  " "
                              ),
                          ...
                          : e._e(),
                        e.activeUploads && e.paused
                          ? o("span", [
                              e._v(" (" + e._s(e.lang("Paused")) + ") "),
                            ])
                          : e._e(),
                        e.activeUploads
                          ? e._e()
                          : o("span", [e._v(" " + e._s(e.lang("Done")) + " ")]),
                      ]),
                      o("div", { staticClass: "is-flex" }, [
                        e.activeUploads
                          ? o(
                  ...
                  e.progressVisible
                    ? o(
                        ...
                        e._l(
                          e.resumable.files.slice().reverse(),
                          function (a, n) {
                            return o("div", { key: n }, [
                              o("div", [
                                o("div", [
                                ...
                                o(
                                  ...
                                  [
                                    o("progress", {
                                      ...
                                      domProps: {
                                        value:
                                          a.size > 0 ? 100 * a.progress() : 100,
                                      },
                                    }),
                                    !a.isUploading() && a.file.uploadingError
                                      ? o(
                                          "a",
                                          {
                                            staticClass: "progress-icon",
      ...
      je = {
        ...
        computed: {
          activeUploads: function () {
            return (
              this.resumable.files.length > 0 && this.resumable.progress() < 1
            );
          },
        },
        watch: {
          ...
          (this.resumable = new Ne.a({
            ...
            maxFileSizeErrorCallback: function (a) {
              e.$notification.open({
                message: e.lang(
                  "File size error",
                  a.name,
                  e.formatBytes(e.$store.state.config.upload_max_size)
                ),
                type: "is-danger",
                queue: !1,
                indefinite: !0,
            ...
            this.resumable.support
              ? (this.resumable.assignDrop(document.getElementById("dropzone")),
                this.resumable.on("fileAdded", function (a) {
                  (e.visible = !0),
                    (e.progressVisible = !0),
                    void 0 === a.relativePath ||
                    null === a.relativePath ||
                    a.relativePath == a.fileName
                      ? (a.relativePath = e.$store.state.cwd.location)
                      : (a.relativePath = [
                          e.$store.state.cwd.location,
                          a.relativePath,
                        ]
                          .join("/")
                          .replace("//", "/")
        ...
        methods: {
          ...
          togglePause: function () {
            this.paused
              ? (this.resumable.upload(), (this.paused = !1))
              : (this.resumable.pause(), (this.paused = !0));
          },
        },
      },
      Ae = je,
      De = (o("f507"), Object(g["a"])(Ae, ze, Ce, !1, null, "07f55d0a", null)),
      Fe = De.exports,
      _e = o("4eb5"),
      Le = o.n(_e);
    n["default"].use(Le.a);
    var Re = {
        name: "Browser",
        components: { Menu: q, Pagination: Ue, Upload: Fe },
        data: function () {
          return {
            dropZone: !1,
            perPage: "",
        ...
        computed: {
          breadcrumbs: function () {
            var e = "",
              a = [{ name: this.lang("Home"), path: "/" }];
            return (
              F.a.forEach(
                F.a.split(this.$store.state.cwd.location, "/"),
                function (o) {
                  (e += o + "/"), a.push({ name: o, path: e });
                }
              ),
          ...
          totalCount: function () {
            return Number(
              F.a.sumBy(this.$store.state.cwd.content, function (e) {
        ...
        methods: {
          ...
          filterEntries: function (e) {
            ...
            if (
              ((this.hasFilteredEntries = !1),
              !this.showAllEntries && "undefined" !== typeof o && o.length > 0)
            ) {
              var n = [];
              return (
                F.a.forEach(e, function (e) {
                  ...
                  F.a.forEach(o, function (o) {
                    if ("undefined" !== typeof o && o.length > 0) {
                      ...
                      if (e.type == r && l.test(s))
                        return (i = !0), (a.hasFilteredEntries = !0), !1;
                    }
                  }),
                    i || n.push(e);
                }),
          ...
          itemClick: function (e) {
            "dir" == e.type || "back" == e.type
              ? this.goTo(e.path)
              : this.can(["download"]) && this.hasPreview(e.path)
              ? this.preview(e)
              : this.can(["download"]) && this.download(e);
          },
          rightClick: function (e, a) {
            "back" != e.type &&
              (a.preventDefault(),
              this.$refs["ref-single-action-button-" + e.path].click());
          },
          selectDir: function () {
            var e = this;
            this.$modal.open({
                ...
                .then(function (a) {
                  (e.isLoading = !1),
                    e.$dialog.alert({
                      ...
                      onConfirm: function () {
                        window.open(
                          n["default"].config.baseURL +
                            "/batchdownload&uniqid=" +
                            a.uniqid,
                          "_blank"
                        );
                      },
          ...
          preview: function (e) {
            var a = null;
            this.isImage(e.path) && (a = ce),
              this.isText(e.path) && (a = re),
              this.$modal.open({
                parent: this,
                props: { item: e },
                hasModalCard: !0,
          ...
          remove: function (e, a) {
            ...
            this.$dialog.confirm({
              ...
              onConfirm: function () {
                (o.isLoading = !0),
                  p
                    .removeItems({ items: a ? [a] : o.getSelected() })
                    .then(function () {
                      (o.isLoading = !1), o.loadFiles();
                    })
                    ["catch"](function (e) {
          ...
          customSort: function (e, a, o, n) {
            return "back" == e.type
              ...
              : "back" == a.type
              ? 1
              : "dir" == e.type && "dir" != a.type
              ? -1
              : "dir" == a.type && "dir" != e.type
              ? 1
              : a.type == e.type
              ? e[n] === a[n]
                ? this.customSort(e, a, !1, "name")
                : F.a.isString(e[n])
                ? e[n].localeCompare(a[n]) * (o ? -1 : 1)
                : (e[n] < a[n] ? -1 : 1) * (o ? -1 : 1)
              : void 0;
          },
        },
      ...
      Te = Re,
      Ee = (o("7182"), Object(g["a"])(Te, U, z, !1, null, "081c0a81", null)),
      $e = Ee.exports,
      xe = function () {
        var e = this,
          a = e.$createElement,
                  ...
                  fn: function (a) {
                    return [
                      ...
                      o(
                        ...
                        [
                          e._v(
                            " " + e._s(e.permissions(a.row.permissions)) + " "
                          ),
                        ]
                      ),
                      o(
                        ...
                        [
                          e._v(
                            " " + e._s(e.lang(e.capitalize(a.row.role))) + " "
                          ),
                        ]
                      ),
                      o("b-table-column", [
          ...
          return o("div", { staticClass: "modal-card" }, [
            ...
            o("section", { staticClass: "modal-card-body" }, [
              o(
                ...
                [
                  "user" == e.user.role || "admin" == e.user.role
                    ? o(
                        "div",
                        { staticClass: "field" },
                        [
                            ...
                            [
                              o(
                                ...
                                [
                                  o(
                                    "option",
                                    { key: "user", attrs: { value: "user" } },
                                    [e._v(" " + e._s(e.lang("User")) + " ")]
                                  ),
                                  o(
                                    "option",
                                    { key: "admin", attrs: { value: "admin" } },
                                    [e._v(" " + e._s(e.lang("Admin")) + " ")]
                                  ),
                                ]
                              ),
                            ],
                            ...
                            [
                              o("b-input", {
                                attrs: {
                                  placeholder:
                                    "edit" == e.action
                                      ? e.lang("Leave blank for no change")
                                      : "",
                                  "password-reveal": "",
                                },
                                nativeOn: {
                  ...
                  o("b-field", { attrs: { label: e.lang("Permissions") } }, [
                    o(
                      "div",
                      { staticClass: "block" },
                      [
                        ...
                        o(
                          ...
                          [
                            e._v(
                              " " + e._s(e.lang("Download permission")) + " "
                            ),
                          ]
                        ),
                        o(
                          ...
                          [e._v(" " + e._s(e.lang("Batch Download")) + " ")]
                        ),
                        o(
                          "b-checkbox",
                          {
        ...
        (o("7db0"),
        {
          ...
          watch: {
            "permissions.read": function (e) {
              e ||
                ((this.permissions.write = !1),
                (this.permissions.batchdownload = !1),
                (this.permissions.zip = !1));
            },
            ...
            "permissions.batchdownload": function (e) {
              e &&
                ((this.permissions.read = !0),
                (this.permissions.download = !0));
            },
            "permissions.zip": function (e) {
              e &&
                ((this.permissions.read = !0), (this.permissions.write = !0));
            },
          },
          methods: {
            selectDir: function () {
            ...
            confirmSave: function () {
              var e = this;
              "guest" == this.formFields.role &&
              this.getPermissionsArray().length
                ? this.$dialog.confirm({
                    message: this.lang(
      ...
      Ie = {
        name: "Users",
        components: { Menu: q, Pagination: Ue },
        data: function () {
          return {
            perPage: "",
            currentPage: 1,
        ...
        methods: {
          remove: function (e) {
            ...
            this.$dialog.confirm({
              ...
              onConfirm: function () {
                p
                  .deleteUser({ username: e.username })
                  .then(function () {
          ...
          editUser: function (e) {
            ...
            e.username
              ? this.$modal.open({
                  parent: this,
                  props: { user: e, action: "edit" },
                  hasModalCard: !0,
                  component: Ze,
                  events: {
                    updated: function (e) {
                      a.users.splice(
                        F.a.findIndex(a.users, { username: e.username }),
                        1,
                        e
                      );
                    },
      ...
      We = Ie,
      Ke = (o("abb7"), Object(g["a"])(We, xe, qe, !1, null, "de886392", null)),
      Ge = Ke.exports,
      Ye = o("2f62"),
      ...
      Xe = {
        ...
        "File size error":
          "{0} is too large, please upload files less than {1}",
      ...
      aa = {
        ...
        "File size error":
          "{0} es demasiado grande, por favor suba ficheros menores a {1}",
        "Upload failed": "{0} no se pudo subir",
        "Per page": "{0} por página",
        Folder: "Carpeta",
        "Login failed, please try again":
          "Inicio de sesión incorrecto, por favor pruebe de nuevo",
        "Already logged in": "Ya había iniciado sesión.",
        "Please enter username and password":
          "Por favor, escriba nombre de usuario y contraseña.",
        ...
        "Are you sure you want to allow access to everyone?":
          "¿Seguro que quiere permitir el acceso a todo el mundo?",
        "Are you sure you want to stop all uploads?":
          "¿Seguro que quiere parar todas las subidas?",
      ...
      na = {
        ...
        "File size error":
          "{0} ist zu groß, bitte nur Dateien hochladen, die kleiner als {1} sind.",
        ...
        "Leave blank for no change":
          "Leer lassen, um keine Änderung vorzunehmen",
        "Are you sure you want to do this?":
          "Sind Sie sicher, dass Sie das tun wollen?",
        "Are you sure you want to allow access to everyone?":
          "Sind Sie sicher, dass Sie jedem den Zugang ermöglichen wollen?",
        "Are you sure you want to stop all uploads?":
          "Sind Sie sicher, dass Sie alle Uploads stoppen wollen?",
      ...
      ra = {
        ...
        "File size error":
          "{0} file terlalu besar, harap unggah file lebih kecil dari {1}",
        ...
        "Are you sure you want to allow access to everyone?":
          "Apakah anda yakin untuk mengizinkan akses ke semua pengguna?",
        "Are you sure you want to stop all uploads?":
          "Apakah anda yakin ingin menghentikan semua unggahan?",
      ...
      sa = {
        ...
        "Are you sure you want to allow access to everyone?":
          "Herkese erişime izin vermek istediğinizinden emin misiniz?",
        "Are you sure you want to stop all uploads?":
          "Tüm yüklemeleri durdurmak istediğinizden emin misiniz?",
      ...
      da = {
        ...
        "File size error":
          "{0} yra per didelis, prašome įkelti mažesnius failus nei {1}",
        ...
        "Leave blank for no change":
          "Palikite tuščią, jei nenorite nieko keisti",
        "Are you sure you want to do this?":
          "Ar Jūs įsitikinęs, kad norite tai atlikti?",
        "Are you sure you want to allow access to everyone?":
          "Ar Jūs įsitikinęs, kad norite atverti prieigą prie failų bet kam?",
        "Are you sure you want to stop all uploads?":
          "Ar Jūs įsitikinęs, kad norite sustabdyti visus įkėlimus?",
      ...
      ca = {
        ...
        "File size error":
          "{0} é muito grande, por favor faça upload de arquivos menores que {1}",
        ...
        "Please enter username and password":
          "Por favor entre com o nome de usuário e a senha",
        ...
        "Leave blank for no change":
          "Deixe em branco para não fazer nenhuma alteração",
        "Are you sure you want to do this?":
          "Tem certeza que deseja fazer isto?",
        "Are you sure you want to allow access to everyone?":
          "Tem certeza que deseja permitir o acesso a todos?",
        "Are you sure you want to stop all uploads?":
          "Tem certeza que deseja parar todos os uploads?",
      ...
      ma = {
        ...
        Folder: "Map",
        "Login failed, please try again":
          "Login mislukt, probeer het nog eens...",
        ...
        "Are you sure you want to allow access to everyone?":
          "Weet u zeker dat u iedereen toegang wil geven?",
        "Are you sure you want to stop all uploads?":
          "Weet u zeker dat u alle uploads wil stoppen?",
      ...
      wa = {
        ...
        "File size error":
          "{0} е твърде голям, моля, качете файлове по-малко от {1}",
        "Upload failed": "{0} Грещка при качване",
        "Per page": "{0} На страница",
        Folder: "Папка",
        "Login failed, please try again":
          "Грешка при вписване, опитайте отново",
        ...
        "Are you sure you want to allow access to everyone?":
          "Сигурни ли сте, че искате да разрешите достъп на всички?",
        "Are you sure you want to stop all uploads?":
          "Сигурни ли сте, че искате да спрете всички качвания?",
      ...
      ya = {
        ...
        "File size error":
          "{0} fajl je preveliki, molim pošaljite fajl manji od {1}",
        ...
        "Are you sure you want to allow access to everyone?":
          "Da li ste sigurni da želite da dozvolite pristup svima?",
        "Are you sure you want to stop all uploads?":
          "Da li ste sigurni da želite da prekinete sva slanja?",
      ...
      ka = {
        ...
        "File size error":
          "{0} est trop volumineux, merci d'uploader des fichiers inférieurs à {1}",
        "Upload failed": "{0} échec(s) d'envoi",
        "Per page": "{0} par page",
        Folder: "Dossier",
        "Login failed, please try again":
          "Identification échoué, veuillez réessayer...",
        ...
        "Are you sure you want to allow access to everyone?":
          "Êtes-vous sûr de vouloir autoriser l'accès à tout le monde ?",
        "Are you sure you want to stop all uploads?":
          "Êtes-vous sûr de vouloir arrêter tous vos envois ?",
      ...
      Ua = {
        ...
        "File size error":
          "{0} je príliš veľký, nahrávajte súbory menšie ako {1}",
        "Upload failed": "{0} sa nepodarilo nahrať",
        "Per page": "{0} na stránku",
        Folder: "Adresár",
        "Login failed, please try again":
          "Prihlásenie neúspešné, skúste to znova",
        ...
        "Are you sure you want to allow access to everyone?":
          "Naozaj chcete povoliť prístup bez hesla?",
        "Are you sure you want to stop all uploads?":
          "Naozaj chcete zastaviť všetky nahrávania?",
      ...
      Ca = {
        ...
        "Are you sure you want to allow access to everyone?":
          "Czy na pewno chcesz zezwolić na dostęp wszystkim?",
        "Are you sure you want to stop all uploads?":
          "Czy na pewno chcesz zatrzymać wszystkie przesyłane pliki?",
      ...
      Na = {
        ...
        "File size error":
          "{0} File troppo grande. Dimensione massima consentita {1}",
        ...
        "Leave blank for no change":
          "Lascia in bianco per non effettuare modifiche",
        "Are you sure you want to do this?":
          "Sei sicuro di voler eliminare gli elementi selezionati?",
        "Are you sure you want to allow access to everyone?":
          "Sei sicuro di voler consentire libero accesso a tutti?",
        "Are you sure you want to stop all uploads?":
          "Vuoi sospendere tutti i caricamenti?",
      ...
      Fa = {
        ...
        "File size error":
          "{0} je příliš velký, nahrávejte soubory menší jak {1}",
        "Upload failed": "{0} se nepodařilo nahrát",
        "Per page": "{0} na stránku",
        Folder: "Adresář",
        "Login failed, please try again":
          "Přihlášení neúspěšné, zkuste to znova",
        ...
        "Are you sure you want to allow access to everyone?":
          "Skutečně chcete povolit přístup bez hesla?",
        "Are you sure you want to stop all uploads?":
          "Skutečně chcete zastavit všechna nahrávání?",
      ...
      La = {
        ...
        "File size error":
          "{0} O arquivo é demasiado grande. Por favor, cargue arquivos de menos de {1}",
        "Upload failed": "{0} Erro ao subir",
        "Per page": "{0} Por páxina",
        Folder: "Cartafol",
        "Login failed, please try again":
          "Houbo un erro no acceso, proba de novo.",
        "Already logged in": "Xa iniciaches sesión.",
        "Please enter username and password":
          "Por favor, insire usuario e contrasinal.",
        ...
        "Are you sure you want to allow access to everyone?":
          "Estás seguro de que queres darlle acceso a calquera?",
        "Are you sure you want to stop all uploads?":
          "Estás seguro de que queres deter todas as cargas?",
      ...
      Ta = {
        ...
        "File size error":
          "{0} слишком большой, пожалуйста, загрузите файл меньше {1}",
        "Upload failed": "{0} не удалось загрузить",
        "Per page": "{0} На страницу",
        Folder: "Папка",
        "Login failed, please try again":
          "Вход не выполнен. Пожалуйста попробуйте еще раз",
        ...
        "Are you sure you want to allow access to everyone?":
          "Вы уверены, что хотите предоставить доступ всем?",
        "Are you sure you want to stop all uploads?":
          "Вы уверены, что хотите остановить все загрузки?",
      ...
      $a = {
        ...
        "Please enter username and password":
          "Kérjük, adja meg a felhasználónevét és jelszavát.",
        ...
        "Are you sure you want to allow access to everyone?":
          "Biztos, hogy mindenkinek engedélyezi a hozzáférést?",
        "Are you sure you want to stop all uploads?":
          "Biztosan leállítja az összes feltöltést?",
      ...
      qa = {
        ...
        "Are you sure you want to allow access to everyone?":
          "Vill du verkligen ge access till alla?",
        "Are you sure you want to stop all uploads?":
          "Vill du stoppa alla uppladdningar?",
      ...
      Oa = {
        ...
        "File size error":
          "{0}が大きすぎます。{1}未満のファイルのみアップロードできます。",
      ...
      Ha = {
        ...
        "File size error":
          "{0} datoteka je prevelika, prosimo, naložite datoteko, manjšo od {1}",
        "Upload failed": "{0} napaka med nalaganjem",
        "Per page": "{0} Na stran",
        Folder: "Mapa",
        "Login failed, please try again":
          "Neuspešna prijava, prosimo, poskusite ponovno",
        ...
        "Are you sure you want to allow access to everyone?":
          "Ste prepričani, da želite dovoliti dostop vsem?",
        "Are you sure you want to stop all uploads?":
          "Ste prepričani, da želite prekiniti vse prenose?",
      ...
      Za = {
        ...
        Folder: "תיקייה",
        "Login failed, please try again":
          "הכניסה נכשלה, אנא בידקו שם משתמש וסיסמה",
        "Already logged in": "אתם כבר מחוברים לאתר.",
        "Please enter username and password":
          "לכניסה למערכת הקלידו שם משתמש וסיסמה.",
        "Not Found": "לא נמצא",
        ...
        "Are you sure you want to do this?":
          "האם אתם בטוחים שברצונכם לעשות פעולה זו?",
        "Are you sure you want to allow access to everyone?":
          "האם אתם בטוחים שתרצו לאפשר גישה לכולם?",
        "Are you sure you want to stop all uploads?":
          "האם אתם בטוחים שתרצו לעצור את כל ההעלאות?",
      ...
      Wa = {
        ...
        "File size error":
          "{0} este prea mare, încărcați fișiere mai mici decât {1}",
        ...
        "Are you sure you want to do this?":
          "Sunteți sigur că doriți să faceți asta?",
        "Are you sure you want to allow access to everyone?":
          "Sunteți sigur că doriți să permiteți accesul tuturor?",
        "Are you sure you want to stop all uploads?":
          "Sunteți sigur că doriți oprirea tuturor încărcărilor?",
      ...
      Ga = {
        ...
        "Are you sure you want to allow access to everyone?":
          "هل أنت متأكد من أنك تريد إتاحة الوصول للجميع؟",
        "Are you sure you want to stop all uploads?":
          "هل أنت متأكد أنك تريد إيقاف جميع عمليات التحميل؟",
      ...
      Ja = {
        ...
        "Uploading files": "Fazendo o upload {0}% de {1}",
        "File size error":
          "{0} é muito grande, por favor faça o upload de ficheiros menores do que {1}",
        "Upload failed": "{0} falhou ao fazer o upload",
        "Per page": "{0} Por Página",
        Folder: "Pasta",
        "Login failed, please try again":
        ...
        "Already logged in": "Já está logado.",
        "Please enter username and password":
          "Por favor, entre com o nome de utilizador e senha.",
        "Not Found": "Não Encontrado",
        "Not Allowed": "Não Autorizado",
        "Please log in": "Por favor, faça o login",
        "Unknown error": "Erro desconhecido",
        ...
        "Are you sure you want to allow access to everyone?":
          "Tem a certeza que deseja permitir o acesso a todos?",
        "Are you sure you want to stop all uploads?":
          "Tem a certeza que deseja parar todos os uploads?",
        "Something went wrong": "Algo deu errado",
      ...
      Xa = {
        ...
        "File size error":
          "{0} حجم فایل زیاد است, لطفا با حجم کمتر از انتخاب نمایید {1}",
        ...
        "Are you sure you want to allow access to everyone?":
          "مطمئنید میخواید همه دسترسی پیدا کنند ؟؟",
        "Are you sure you want to stop all uploads?":
          "تمام آپلود ها کنسل شود ؟؟",
      ...
      ao = {
        ...
        "File size error":
          "{0} on liiga suur, palun laadige faile üles vähem kui {1}",
        ...
        "Please enter username and password":
          "Palun sisestage kasutajanimi ja parool.",
        "Not Found": "Ei leitud",
        ...
        "Are you sure you want to do this?":
          "Kas oled kindel, et soovid seda teha?",
        "Are you sure you want to allow access to everyone?":
          "Kas oled kindel, et soovid lubada juurdepääsu kõigile?",
        "Are you sure you want to stop all uploads?":
          "Kas oled kindel, et soovid kõik üleslaadimised peatada?",
        ...
        methods: {
          lang: function (e) {
            for (
              ...
              i[r - 1] = arguments[r];
            var t = i;
            return a[o] && void 0 != a[o][e]
              ? a[o][e].replace(/{(\d+)}/g, function (e, a) {
          ...
          checkUser: function () {
            ...
            p.getUser()
              .then(function (a) {
                a.username !== ro.state.user.username &&
                  (e.$store.commit("destroyUser", a),
                  e.$toast.open({
          ...
          handleError: function (e) {
            this.checkUser(),
              "string" != typeof e
                ? e && e.response && e.response.data && e.response.data.data
                  ? this.$toast.open({
          ...
          getDownloadLink: function (e) {
            return (
              n["default"].config.baseURL +
              "/download&path=" +
              encodeURIComponent(u["Base64"].encode(e))
            );
          },
          ...
          isText: function (e) {
            return this.hasExtension(e, ro.state.config.editable);
          },
          isImage: function (e) {
      ...
      io = no;
    n["default"].use(Ye["a"]);
    var ro = new Ye["a"].Store({
      state: {
        initialized: !1,
        config: [],
        user: { role: "guest", permissions: [], name: "", username: "" },
      ...
      getters: {
        hasPermissions: function (e) {
          return function (a) {
            return F.a.isArray(a)
              ? F.a.intersection(e.user.permissions, a).length == a.length
              : !!F.a.find(e.user.permissions, function (e) {
                  return e == a;
                });
          };
        },
      ...
      mutations: {
        ...
        resetCwd: function (e) {
          e.cwd = { location: "/", content: [] };
        },
        resetTree: function (e) {
          e.tree = { path: "/", name: io.methods.lang("Home"), children: [] };
        },
        ...
        destroyUser: function (e) {
          e.user = { role: "guest", permissions: [], name: "", username: "" };
        },
        setCwd: function (e, a) {
          (e.cwd.location = a.location),
            (e.cwd.content = []),
            F.a.forEach(
              F.a.sortBy(a.content, [
                function (e) {
    ...
    (n["default"].config.productionTip = !1),
      ...
      (d.a.defaults.baseURL = n["default"].config.baseURL),
      (d.a.defaults.headers["Content-Type"] = "application/json"),
      n["default"].use(lo.a, { defaultIconPack: "fas" }),
      n["default"].use(uo["a"], { preLoad: 1.3 }),
      n["default"].mixin(io),
      new n["default"]({
        router: to,
        store: ro,
        created: function () {
          ...
          p.getConfig()
            .then(function (a) {
              e.$store.commit("setConfig", a.data.data),
                p
                  .getUser()
                  .then(function (a) {
                    e.$store.commit("initialize"),
